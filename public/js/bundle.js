...
var displayMap = function displayMap(locations) {
  var map = new maplibregl.Map({
    container: 'map',
    style: 'https://api.jawg.io/styles/jawg-light.json?access-token=ScAlWcI65q8shy3WNVjTp2bZHEpAF68TTCdpOWQZWLmyNdI0fHUSht3RA8O02dmK',
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_51IT0EUBCxZcGzl0sqvKRjsFPf4R0LAR5wjaysmydtddj6y2uKEj959AdzWIK0vZSF51r7yHcaV82dL0INzGJnfYz00XAAmvGoS');
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(tourId, review, rating) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function reviewFunc(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.reviewFunc = reviewFunc;
...
var reviewbtn = document.getElementById('review-btn'); // DELEGATION
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 10;
            return (0, _review.reviewFunc)(tourId, reviewText, rating);
